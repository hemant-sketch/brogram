        ...
        <>
            ...
            <ul className="rules-list">
                <div className="rule-item">
                    <p><b>Rest</b></p>
                    <p>Ensure that you taking rest days where necessary</p>
                </div>
                <div className="rule-item">
                    <p><b>Reps</b></p>
                ...
                <div className="rule-item">
                    <p><b>Weight*</b></p>
                    <p>Select the maximum weight that allows you to complete the set with goof from</p>
                </div>
            </ul>
            ...
            <p>This training plan uses a structure knnown as <b>Bro Split</b>, and follows this rotation ⬇️</p>
